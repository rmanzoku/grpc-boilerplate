...
var file_ping_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0x52, 0x0a, 0x0b, 0x50, 0x69, 0x6e, 0x67, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x43, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67, 0x12, 0x12, 0x2e, 0x70,
	...
	0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0x12, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0c, 0x22, 0x05, 0x2f,
	0x70, 0x69, 0x6e, 0x67, 0x3a, 0x03, 0x6d, 0x73, 0x67, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x72, 0x6d, 0x61, 0x6e, 0x7a, 0x6f, 0x6b, 0x75,
	0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x62, 0x6f, 0x69, 0x6c, 0x65, 0x72, 0x70, 0x6c, 0x61, 0x74,
	0x65, 0x2f, 0x66, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x2f, 0x70, 0x69, 0x6e, 0x67, 0x62, 0x06,
...
var file_ping_proto_depIdxs = []int32{
	0, // 0: ping.PingService.Ping:input_type -> ping.MessageInput
	1, // 1: ping.PingService.Ping:output_type -> ping.MessageOutput
...
type PingServiceClient interface {
	Ping(ctx context.Context, in *MessageInput, opts ...grpc.CallOption) (*MessageOutput, error)
}
...
func (c *pingServiceClient) Ping(ctx context.Context, in *MessageInput, opts ...grpc.CallOption) (*MessageOutput, error) {
...
type PingServiceServer interface {
	Ping(context.Context, *MessageInput) (*MessageOutput, error)
}
...
func (*UnimplementedPingServiceServer) Ping(context.Context, *MessageInput) (*MessageOutput, error) {
...
func _PingService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingServiceServer).Ping(ctx, req.(*MessageInput))
	}
