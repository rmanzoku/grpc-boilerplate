...
printUsage() {
    ...
    echo " --grpc-web-mode                 This option overrides the 'grpc-web_out=' argument in the grpc-web code generation. Defaults to 'import_style=typescript'."
}
...
:$OUT_DIR"
    ...
    "node")
        ...
        ;;
    "web")
        GEN_STRING="--grpc-web_out=import_style=typescript,mode=grpcweb:$OUT_DIR --js_out=import_style=commonjs:$OUT_DIR --plugin=protoc-gen-grpc-web=`which grpc_${PLUGIN_LANG}_plugin`"
        ;;
    "descriptor_set")
